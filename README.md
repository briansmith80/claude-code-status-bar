...
Eight built-in themes. Each strip shows the theme's palette in the order the colours land on the bar: **directory · branch · model · Opus accent · additions · warnings/cost · removals · pacing marker**.

| Theme | Palette |
|-------|---------|
| `default` | <img src="docs/assets/themes/default.svg" alt="default theme palette: cyan, magenta, blue, orange, green, yellow, red, pink" width="400"> |
| `nord` | <img src="docs/assets/themes/nord.svg" alt="nord theme palette: frost blues and aurora accents" width="400"> |
| `dracula` | <img src="docs/assets/themes/dracula.svg" alt="dracula theme palette: purple, pink, cyan, orange, green" width="400"> |
| `solarized` | <img src="docs/assets/themes/solarized.svg" alt="solarized theme palette: cyan, violet, blue, orange, green" width="400"> |
| `tokyo-night` | <img src="docs/assets/themes/tokyo-night.svg" alt="tokyo-night theme palette: blues, purple, cyan, soft red" width="400"> |
| `catppuccin` | <img src="docs/assets/themes/catppuccin.svg" alt="catppuccin theme palette: pastel blue, mauve, sapphire, peach" width="400"> |
| `matrix` | <img src="docs/assets/themes/matrix.svg" alt="matrix theme: monochrome digital-rain phosphor green" width="400"> |
| `mono` | <img src="docs/assets/themes/mono.svg" alt="mono theme: no colour, a neutral grey ramp" width="400"> |

`default` follows your terminal's own ANSI palette (the swatch shows a representative set), so it tracks whatever colour scheme your terminal uses. `matrix` is a *Matrix* digital-rain tribute: monochrome phosphor green, so its segments are separated by brightness rather than hue (removals are a dim green, not red). `mono` emits no colour at all, and **any** theme degrades to plain text when [`NO_COLOR`](https://no-color.org/) is set. (Swatches are generated by `docs/assets/themes/generate-swatches.js` from the palettes in `apply_theme()`.)
